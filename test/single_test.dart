...
void start() {
  ...
  test('deposit', () async {
    final DepositResponse value = await acquiring.deposit(
      DepositRequest(
        amount: 100,
        orderId: orderId,
      ),
  ...
  test('reverse', () async {
    final ReverseResponse value = await acquiring.reverse(
      ReverseRequest(
        orderId: orderId,
  ...
  test('refund', () async {
    final RefundResponse value = await acquiring.refund(
      RefundRequest(
        orderId: orderId,
        amount: 100,
        jsonParams: <String, dynamic>{'test': 1},
  ...
  test('verifyEnrollment', () async {
    final VerifyEnrollmentResponse value = await acquiring.verifyEnrollment(
  ...
  test('decline', () async {
    final DeclineResponse value = await acquiring.decline(
      DeclineRequest(
        merchantLogin: 'test',
        orderId: orderId,
        orderNumber: orderNumber,
  ...
  test('getReceiptStatus', () async {
    final GetReceiptStatusResponse value = await acquiring.getReceiptStatus(
  ...
  test('bindCard', () async {
    final BindCardResponse value = await acquiring.bindCard(
      BindCardRequest(
        bindingId: bindingId,
      ),
    );
  ...
  test('getBindingsByCardOrId', () async {
    final GetBindingsByCardOrIdResponse value =
        await acquiring.getBindingsByCardOrId(
  ...
  test('extendBinding', () async {
    final ExtendBindingResponse value = await acquiring.extendBinding(
...
void register({bool preAuth = false}) {
  test('register, preAuth: $preAuth', () async {
    final RegisterResponse value = await acquiring.register(
      RegisterRequest(
        preAuth: preAuth,
        orderNumber: orderNumber,
        amount: 100,
